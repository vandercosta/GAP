...
public class MenuFornecedor extends javax.swing.JPanel implements ComandoJanelaInterna {
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        ...
        Processador.abrirJanela("novoFornecedor");
        ...
        if (jt.getSelectedRow() != -1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Deseja Excluir:", "AVISO", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) == 0) {
                ...
                for (int i = 0; i < this.lista.size(); i++) {
                    if (this.lista.get(i).getIdFornecedor()== idSelecionado) {
                        this.selecionado = this.lista.get(i);
                        int linha = jt.getSelectedRow();
                        this.tabela.removeFornecedores(linha);
    ...
    public void buscarTodos() {
        ...
        this.tabela.setFornecedor(this.lista);
        jt.setModel(tabela);
    }
    ...
    public void editar() {
        ...
        if (jt.getSelectedRow() != -1) {
            ...
            for (int i = 0; i < this.lista.size(); i++) {
                if (this.lista.get(i).getIdFornecedor() == idSelecionado) {
                    this.selecionado = this.lista.get(i);
                    Processador.abrirEditar("editarFornecedor", this.selecionado);
                    break;
                }
            }
        } else {

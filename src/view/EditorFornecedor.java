...
public class EditorFornecedor extends javax.swing.JFrame implements ComandoJanela {
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(11, 11, 11)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(textCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        long cnpj;
        if (textCnpj.getText().trim().equals("")) {
            cnpj = 0;
        } else {
    ...
    public void abrirJanelas(Object obj) {
        ...
        this.editado = (Fornecedor) obj;
        textNome.setText(this.editado.getNome());
        textCnpj.setText(String.valueOf(this.editado.getCnpj()));

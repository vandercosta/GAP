...
public class NovoProduto extends javax.swing.JFrame implements ComandoJanela {
    ...
    private void initComponents() {
        ...
        combo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecionar ..." }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (textValor.getText().trim().equals("")) {
            ...
            valor = Long.valueOf(textValor.getText());
        }
        String modelo = textModelo.getText();
        String categoriat = combo.getSelectedItem().toString();

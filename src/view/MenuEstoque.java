...
public class MenuEstoque extends javax.swing.JPanel implements ComandoJanelaInterna {
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        ...
        Processador.abrirJanela("novoProduto");
    ...
    public void editar() {
        if (jt.getSelectedRow() != -1) {
            ...
            for (int i = 0; i < this.lista.size(); i++) {
                if (this.lista.get(i).getIdProduto()== idSelecionado) {
                    this.selecionado = this.lista.get(i);
                    Processador.abrirEditar("editarProduto", this.selecionado);
                    break;
                }
            }
        } else {
